...
export default function CaseStudyCard({ tag, title, body, stats }: CaseStudyCardProps) {
  return (
    <article className="hairline flex flex-col gap-5 rounded-2xl border bg-gradient-to-b from-surface/70 to-bg/40 p-7 transition-colors duration-[var(--hover-duration)] ease-[var(--ease-out)] hover:border-muted/30 sm:p-11">
      <span className="w-fit rounded-full border border-teal/35 px-3.5 py-1.5 text-[0.6875rem] uppercase tracking-[0.1em] text-teal">
        {tag}
      </span>
